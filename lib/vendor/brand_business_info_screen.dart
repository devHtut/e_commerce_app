...
class BrandBusinessInfoScreen extends StatefulWidget {
  const BrandBusinessInfoScreen({super.key});

  @override
  State<BrandBusinessInfoScreen> createState() =>
      _BrandBusinessInfoScreenState();
}

class _BrandBusinessInfoScreenState extends State<BrandBusinessInfoScreen> {
  ...
  final List<_BrandPaymentEntry> _paymentEntries = [];
  ...
  Widget _buildPaymentEntry(int index, _BrandPaymentEntry entry) {
    return Container(
  ...
  Future<void> _saveBusinessInfo() async {
    ...
    try {
      ...
      await showCustomPopup(
        ...
        message: 'Your business and payment details have been saved.',
  ...
  Future<void> _requestLeave() async {
    ...
    if (!_hasDraftInput ||
        await showDiscardChangesDialog(
          context,
          title: 'Discard business changes?',
        )) {
      _popAfterAllow();
    }
  }
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 8),
                        const Text(
                          'Update your business location and payment details for customer orders.',
